 ...
 *
 * Recovery reads `opId` to decide ownership (op-runtime.js:764/781/800); nothing
 * reads a durability field. So a degradation note is advisory: it tells an operator
 * (and any future recovery logic) that this tree was published without a full
 * flush, without turning a permissions quirk into an outage.
 */
