	...
	factory: (require) => {
		...
		const STRINGS = {
			en: {
				...
				"ui.retrieval.indexLine": "Full-text index: {enabled} · {available}",
				"ui.disposal.manual": "Manual",
				"ui.disposal.suggest": "Suggest",
				"ui.disposal.tidy": "Tidy",
				"ui.disposal.maxPerRunLabel": "Soft-delete at most per run:",
				"ui.disposal.coolingLine": "Cooling-off period: {days} days. Recomputed while idle{computed}.",
				"ui.disposal.computedAt": ", last computed {when}",
				"ui.disposal.candidateMeta": "cold for {days} days · {reason}",
				"ui.disposal.cleanupHint": "To actually clean up, tick items under \"controlled pruning\" below (two-stage preview then confirm, all reversible).",
				"ui.prune.convergeMeta": " · {names}｜similarity {similarity}{zeroLoad}",
				"ui.overview.memLine": "Memories: {total} total ({confirmed} confirmed / {pending} pending), limit {max}",
				"ui.prune.memTitle": "Memories awaiting cleanup",
				"ui.prune.noCandidates": "(no cleanup candidates)",
				"ui.prune.skipped": "skipped",
				"ui.prune.confirmBtn": "Confirm and run",
				"ui.prune.cancelBtn": "Cancel",
				"ui.prune.restoreBtn": "Restore",
				"ui.overview.mostInjected": "Most injected (the ones that actually shape decisions):",
			...
			zh: {
				...
				"ui.retrieval.indexLine": "全文索引：{enabled} · {available}",
				"ui.disposal.manual": "手动",
				"ui.disposal.suggest": "建议",
				"ui.disposal.tidy": "整理",
				"ui.disposal.maxPerRunLabel": "每轮最多自动软删：",
				"ui.disposal.coolingLine": "冷静期：{days} 天。空闲时自动重算{computed}。",
				"ui.disposal.computedAt": "，上次算于 {when}",
				"ui.disposal.candidateMeta": "冷置 {days} 天 · {reason}",
				"ui.disposal.cleanupHint": "要真正清理，请到下方「受控剪枝」勾选执行（两阶段预览→确认，全部可逆）。",
				"ui.prune.convergeMeta": " · {names}｜相似度 {similarity}{zeroLoad}",
				"ui.overview.memLine": "记忆：共 {total}（已确认 {confirmed} / 待确认 {pending}），上限 {max}",
				"ui.prune.memTitle": "待清理记忆",
				"ui.prune.noCandidates": "（无待清理候选）",
				"ui.prune.skipped": "跳过",
				"ui.prune.confirmBtn": "确认执行",
				"ui.prune.cancelBtn": "取消",
				"ui.prune.restoreBtn": "恢复",
				"ui.overview.mostInjected": "最常被注入（真正影响决策）：",
				"ui.overview.loading": "加载中…"
			}
		};
		/**
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [
				...
				/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						cfg?.approvalMode === "autonomous" && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							style: {
								...dim,
								marginTop: 8,
								color: "var(--dsh-warn, #b45309)"
							},
							children: t$1("ui.ingest.autonomousWarn", {
								perTurn: cfg?.reviewMaxAutoPerTurn ?? 5,
								queueMax: cfg?.maxPendingQueue ?? 50
							})
						})
					]
				}),
				/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					style: box,
					children: [
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("b", { children: t$1("ui.skillApproval.title") }),
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							style: dim,
							children: t$1("ui.skillApproval.desc")
						}),
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("select", {
							...
							children: [
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("option", {
									value: "inherit",
									children: t$1("ui.skillApproval.inherit", { mode: cfg?.approvalMode ?? "balanced" })
								}),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("option", {
									value: "manual",
									children: t$1("ui.skillApproval.manual")
								}),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("option", {
									value: "balanced",
									children: t$1("ui.skillApproval.balanced")
								}),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("option", {
									value: "autonomous",
									children: t$1("ui.skillApproval.autonomous")
								})
							]
						}),
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [
								t$1("ui.skillApproval.manualCharsPrefix"),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
									type: "number",
									min: 1e3,
									max: 5e5,
								...
								t$1("ui.skillApproval.manualCharsSuffix"),
								t$1("ui.skillApproval.autoCharsPrefix"),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
									type: "number",
									min: 1e3,
									max: 2e5,
								...
								t$1("ui.skillApproval.autoCharsSuffix")
							]
						}),
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
							...
							}), t$1("ui.skillApproval.promptToggle")]
						}),
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							style: dim,
							children: [
								t$1("ui.skillApproval.promptDescPrefix"),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
									type: "number",
									min: 0,
									max: 10,
								...
								t$1("ui.skillApproval.promptDescSuffix")
							]
						})
					]
				}),
				frozenOps.length > 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("b", { children: t$1("ui.frozenOps.title", { count: frozenOps.length }) }),
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							style: dim,
							children: t$1("ui.frozenOps.desc")
						}),
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("table", {
							...
							children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("tbody", { children: frozenOps.map((op) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("tr", { children: [
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("td", {
									...
									children: op.resolution?.status === "RESOLVED" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										style: dim,
										children: t$1("ui.frozenOps.resolved", { decision: op.resolution.decision })
									}) : /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
										/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
											style: btnTiny,
											disabled: saving,
											onClick: () => void resolveOp(op, "ROLL_FORWARD"),
											children: t$1("ui.op.rollForwardBtn")
										}),
										" ",
										/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
											style: btnTiny,
											...
											children: t$1("ui.op.rollBackBtn")
										})
									] })
								})
							] }, op.opId)) })
				...
				s?.proposals && s.proposals.length > 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					style: box,
					children: [
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("b", { children: t$1("ui.proposals.title", { count: s.proposals.length }) }),
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							style: dim,
							children: t$1("ui.proposals.desc")
						}),
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("table", {
							style: {
								width: "100%",
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("td", {
									...
									children: p.state === "pending" ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
										/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
											...
											children: t$1("ui.proposals.apply")
										}),
										" ",
										/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
											style: btnTiny,
											...
											children: t$1("ui.proposals.reject")
										})
									] }) : null
								})
							] }, p.id)) })
				...
				/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					style: box,
					children: [
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("b", { children: t$1("ui.pending.title") }),
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							style: dim,
							children: t$1("ui.pending.desc")
						}),
						s && s.memoryStats.pendingQueue.length > 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("table", {
								...
								children: [
									...
									/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("td", {
										...
										children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", { children: r.content }), r.sourceContext ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
											...
											children: [t$1("ui.pending.source"), r.sourceContext]
										}) : null]
									}),
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("td", {
										style: {
										...
										children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
											...
											title: t$1("ui.pending.discardTitle"),
											children: t$1("ui.pending.discard")
										})
									})
								]
							}, r.id)) })
							...
							children: t$1("ui.pending.confirmAll", { count: s.memoryStats.pendingQueue.length })
						})] }) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							style: {
								...dim,
								marginTop: 8
							},
							children: t$1("ui.pending.empty")
						})
					]
				}),
				s?.rejectedQueue && s.rejectedQueue.length > 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					style: box,
					children: [
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("b", { children: t$1("ui.rejected.title", { count: s.rejectedQueue.length }) }),
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							style: dim,
							children: t$1("ui.rejected.desc")
						}),
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("table", {
							style: {
								width: "100%",
								...
								children: [
									...
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("td", {
										...
										children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
											...
											title: t$1("ui.rejected.restoreTitle"),
											children: t$1("ui.common.restore")
										})
									})
								]
							}, r.id)) })
				...
				s?.unclaimedSkills && s.unclaimedSkills.length > 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					style: box,
					children: [
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("b", { children: t$1("ui.unclaimed.title", { count: s.unclaimedSkills.length }) }),
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							style: dim,
							children: t$1("ui.unclaimed.desc")
						}),
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("table", {
							style: {
								width: "100%",
								...
								children: [
									...
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("td", {
										...
										children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
											...
											title: t$1("ui.unclaimed.claimTitle"),
											children: t$1("ui.unclaimed.claim")
										})
									})
								]
							}, k.name)) })
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
							...
							children: t$1("ui.unclaimed.claimAll", { count: s.unclaimedSkills.length })
						})
					]
				}) : null,
				s?.retrieval ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					style: box,
					children: [
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("b", { children: t$1("ui.retrieval.title") }),
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							style: {
								...mono,
								marginTop: 8
							...
							children: s.retrieval.mode === "fused" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								style: { color: "#16a34a" },
								children: t$1("ui.retrieval.fused")
							}) : s.retrieval.mode === "bigram-only" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								style: { color: "var(--dsh-warn, #b45309)" },
								children: t$1("ui.retrieval.bigramOnly")
							}) : s.retrieval.mode === "fts-degraded" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								style: { color: "#dc2626" },
								children: t$1("ui.retrieval.degraded", { errors: s.retrieval.ftsErrorCount ?? 0 })
							}) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								style: dim,
								children: t$1("ui.retrieval.unknown")
							})
						}),
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							style: {
							...
							children: [t$1("ui.retrieval.indexLine", {
								enabled: s.retrieval.ftsEnabled ? t$1("ui.retrieval.enabled") : t$1("ui.retrieval.disabled"),
								available: s.retrieval.ftsAvailable ? t$1("ui.retrieval.available") : t$1("ui.retrieval.unavailable")
							}), typeof s.retrieval.fusedCount === "number" ? t$1("ui.retrieval.counts", {
								fused: s.retrieval.fusedCount,
								degraded: s.retrieval.bigramOnlyCount ?? 0
							}) : ""]
						})
					]
				}) : null,
				/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					style: box,
					children: [
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("b", { children: t$1("ui.disposal.title") }),
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							style: dim,
							children: t$1("ui.disposal.desc")
						}),
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							style: {
								marginTop: 10,
							...
							children: [
								[
									"manual",
									t$1("ui.disposal.manual"),
									t$1("ui.disposal.manualDesc")
								],
								[
									"suggest",
									t$1("ui.disposal.suggest"),
									t$1("ui.disposal.suggestDesc")
								],
								[
									"tidy",
									t$1("ui.disposal.tidy"),
									t$1("ui.disposal.tidyDesc")
								]
							].map(([mode, label, desc]) => {
						...
						cfg?.disposalMode === "tidy" ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
							...
							children: [
								t$1("ui.disposal.maxPerRunLabel"),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
									type: "number",
									min: 1,
									max: 100,
						...
						(cfg?.disposalMode === "suggest" || cfg?.disposalMode === "tidy") && s?.disposalSuggest ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
									style: dim,
									children: t$1("ui.disposal.coolingLine", {
										days: cfg?.disposalMinIdleDays ?? 30,
										computed: s.disposalSuggest.computedAt ? t$1("ui.disposal.computedAt", { when: new Date(s.disposalSuggest.computedAt).toLocaleString() }) : t$1("ui.disposal.notYetComputed")
									})
								}),
								s.disposalSuggest.candidates.length > 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("table", {
									...
									children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("tbody", { children: s.disposalSuggest.candidates.map((c) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("tr", {
										...
										children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("td", {
											...
											style: { paddingLeft: 8 },
											children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", { children: c.content }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
												style: {
													...dim,
													fontSize: 11
												},
												children: t$1("ui.disposal.candidateMeta", {
													days: c.ageDays,
													reason: c.reason
												})
											})]
									...
									children: t$1("ui.disposal.noCandidates")
								}),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
									style: {
										...dim,
									...
									children: t$1("ui.disposal.cleanupHint")
								})
							]
						}) : null
					]
				...
				/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					style: box,
					children: [
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("b", { children: t$1("ui.prune.title") }),
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							style: dim,
							children: t$1("ui.prune.desc")
						}),
						prune?.budget?.enabled ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							style: {
								...mono,
								marginTop: 8,
								color: prune.budget.overBudget ? "#dc2626" : void 0
							},
							children: t$1("ui.prune.budget", {
								used: prune.budget.used,
								max: prune.budget.max,
								over: prune.budget.overBudget ? t$1("ui.prune.overBudget") : ""
							})
						}) : null,
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							style: { marginTop: 10 },
							children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("b", {
								style: { fontSize: 13 },
								children: t$1("ui.prune.memTitle")
							})
						}),
						prune && prune.memoryCandidates.length > 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("table", {
							...
							children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("tbody", { children: prune.memoryCandidates.map((c) => {
								...
								return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("tr", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("td", {
									...
									children: [
										...
										typeof c.heat === "number" ? t$1("ui.prune.heat", { heat: c.heat }) : "",
										typeof c.injectionCount === "number" ? t$1("ui.prune.injected", { count: c.injectionCount }) : ""
									]
								})] })] }, c.id);
							}) })
						}) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							...
							children: t$1("ui.prune.noCandidates")
						}),
						prune && prune.memoryCandidates.length > 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							...
							children: !preview ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								...
								children: t$1("ui.prune.previewBtn")
							}) : /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								style: {
								...
								children: [
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
										...
										children: t$1("ui.prune.previewTitle")
									}),
										...
										children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("thead", { children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("tr", {
											...
											children: [
												/* @__PURE__ */ (0, react_jsx_runtime.jsx)("th", {
													...
													children: t$1("ui.prune.colAction")
												}),
												/* @__PURE__ */ (0, react_jsx_runtime.jsx)("th", {
													style: { padding: "2px 6px" },
													children: t$1("ui.prune.colCount")
												}),
												/* @__PURE__ */ (0, react_jsx_runtime.jsx)("th", {
													style: { padding: "2px 6px" },
													children: t$1("ui.prune.colResult")
												}),
												/* @__PURE__ */ (0, react_jsx_runtime.jsx)("th", {
													style: { padding: "2px 6px" },
													children: t$1("ui.prune.colNote")
												})
											]
											...
											children: [
												...
												/* @__PURE__ */ (0, react_jsx_runtime.jsx)("td", {
													...
													children: p.allowed ? t$1("ui.prune.willRun") : t$1("ui.prune.skipped")
												}),
												/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("td", {
													style: {
														padding: "2px 6px",
													...
													children: [p.allowed ? "" : p.reason, p.requires ? t$1("ui.prune.requires", { what: p.requires }) : ""]
												})
											]
										}, i)) })]
									}),
									/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
											...
											children: t$1("ui.prune.confirmBtn")
										}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
											style: btn,
											disabled: saving,
											onClick: () => setPreview(null),
											children: t$1("ui.prune.cancelBtn")
										})]
									})
								]
							})
						...
						prune && prune.protectedReview.length > 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("b", {
									style: { fontSize: 13 },
									children: t$1("ui.prune.protectedTitle")
								}),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
									style: dim,
									children: t$1("ui.prune.protectedDesc")
								}),
						...
						prune && prune.skillCandidates.length > 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("b", {
									style: { fontSize: 13 },
									children: t$1("ui.prune.convergeTitle")
								}),
								prune.skillCandidates.map((sc, i) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
									style: {
										...mono,
										paddingLeft: 12,
										opacity: .85
									},
									children: t$1("ui.prune.convergeMeta", {
										names: sc.names.join(" ↔ "),
										similarity: sc.similarity,
										zeroLoad: typeof sc.zeroLoadCount === "number" ? t$1("ui.prune.zeroLoad", { count: sc.zeroLoadCount }) : ""
									})
								}, i)),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
									style: {
									...
									children: t$1("ui.prune.convergeHint")
								})
							]
						}) : null,
						prune && prune.forgotten.length > 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("b", {
								style: { fontSize: 13 },
								children: t$1("ui.prune.forgottenTitle")
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
									...
									children: t$1("ui.prune.restoreBtn")
								})]
							}, r.id))]
						}) : null
					]
				...
				/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					style: box,
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("b", { children: t$1("ui.overview.title") }), s ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						style: {
							marginTop: 8,
							...mono
						},
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", { children: t$1("ui.overview.memLine", {
								total: s.memoryStats.total,
								confirmed: s.memoryStats.confirmed,
								pending: s.memoryStats.pending,
								max: s.memoryStats.maxRecords
							}) }),
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								style: { marginTop: 4 },
								children: t$1("ui.overview.byKind", { kinds: Object.entries(s.memoryStats.byKind).map(([k, v]) => `${k}:${v}`).join("  ") || "—" })
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								style: { marginTop: 4 },
								children: t$1("ui.overview.mostInjected")
							}),
							...
							triageOn ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								style: { marginTop: 4 },
								children: t$1("ui.overview.triage", {
									turns: triage.totalTurns,
									successes: triage.successes,
								...
								children: t$1("ui.overview.triageOff")
							})
						]
					}) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						style: {
						...
						children: t$1("ui.overview.loading")
					})]
				}),
				...
				archives.length > 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					style: box,
					children: [
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("b", { children: t$1("ui.archives.title", { count: archives.length }) }),
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							style: dim,
							children: t$1("ui.archives.desc")
						}),
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("table", {
							style: {
								width: "100%",
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("td", {
									...
									children: [
										...
										/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
											...
											children: t$1("ui.archives.proposeRollback")
										})
									]
								})
							] }, a.archiveId)) })
