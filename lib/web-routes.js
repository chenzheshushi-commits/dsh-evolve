...
export function makeEvolveRoutes(deps) {
  ...
  const state = {
    ...
    handler: async (req, res) => {
      ...
      try {
        json(res, 200, { ok: true, config, models, memoryStats, skillStats: skillStatsVal, retrieval, disposalSuggest, rejectedQueue, unclaimedSkills });
      } catch (e) {
