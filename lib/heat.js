/**
 * Heat: a READ-ONLY time-coldness signal (v0.4.2), adapted from dsh-mneme (MIT).
 *
 ...
 * (merge/refine bumps updatedAt but that is not "accessed"; dsh-mneme v0.7.0
 * fixed exactly this — we adopt the correct version). λ from cfg.heatKindDecay
 * by kind, α from cfg.heatGlobalAlpha.
 */
