 ...
 * timer. Uses a single unref'd setTimeout re-armed on each write (dsh-mneme's
 ...
 * alive.
 *
 * ⚠️ NEVER setInterval / polling. Callback does READ-ONLY candidate recompute
 * only — NEVER any disposal. dispose() must clear the pending timer.
 *
