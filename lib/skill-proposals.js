...
export class ProposalStore{
 ...
 update(id,patch){const cur=this.read(id);if(!cur)throw new Error('proposal not found');const next={...cur,...patch,updatedAt:nowIso()};delete next.body;const p=join(this.dir(id),'meta.json');writeFileAtomic(p,JSON.stringify(next,null,2)+'\n',0o600);return next}
